					...
					<div class="row">
						...
						<ul class="project-wrapper wow animated fadeInUp">
							<li class="portfolio-item">
								<img src="img/portfolio/macias.jpg" class="img-responsive" alt="Desarrollado por servitecex" >
								<figcaption class="mask">
									<h3>Electrodomesticos Macias</h3>
									<p>Desarrollado en parte por Francisco Javier Lindo Vázquez. </p>
								</figcaption>
								<ul class="external">
									<li><a class="fancybox" title="Electrodomesticos Macias" data-fancybox-group="works" href="img/portfolio/macias.jpg"><i class="fa fa-search"></i></a></li>
									<li><a href="http://electrodomesticosmacias.com/"><i class="fa fa-link"></i></a></li>
								</ul>
							</li>

							<li class="portfolio-item">
								<img src="img/portfolio/abogados.jpg" class="img-responsive" alt="Desarrollado por servitecex">
								<figcaption class="mask">
									<h3>Abogados DaP</h3>
									<p>Desarrollado en parte por Francisco Javier Lindo Vázquez. </p>
								</figcaption>
								<ul class="external">
									<li><a class="fancybox" title="Abogados DaP" href="img/portfolio/abogados.jpg" data-fancybox-group="works" ><i class="fa fa-search"></i></a></li>
									<li><a href="http://abogadosdap.com"><i class="fa fa-link"></i></a></li>
								</ul>
							</li>
